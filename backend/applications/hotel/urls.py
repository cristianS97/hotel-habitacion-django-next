...
from .views import HotelListView, HotelListAPIView, HotelCreateAPIView, HotelRetrieveAPIView, HotelUpdateAPIView, HotelDestroyAPIView
...
urlpatterns = [
    ...
    path("api/hotel/eliminar/<int:pk>", HotelDestroyAPIView.as_view(), name="eliminarHotelAPI")
]
